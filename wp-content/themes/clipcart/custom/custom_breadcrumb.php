...
class Custom_Breadcrumb {
    ...
    protected function get_cpt_crumb() {
        ...
        //$title = (strlen($title) > 22) ? substr($title, 0 , 30) . '...' : $title;
        $title = excerpt_paragraph($title, 30);
        
        $crumb .= $this->args['sep'] . $title;
...
function custom_breadcrumb( $args = array() ) {
    ...
    global $_custom_breadcrumb;

    if ( ! $_custom_breadcrumb )
        $_custom_breadcrumb = new Custom_Breadcrumb;

    $_custom_breadcrumb->output( $args );
