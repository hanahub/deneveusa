...
class themedy_ad_widget extends WP_Widget {
	...
	function Themedy_Ad_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'themedy_ad_widget', 'description' => __('A widget that allows the display and configuration of 6 125x125 ads blocks.', 'themedy') );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad_widget' );

		/* Create the widget */
		$this->WP_Widget( 'themedy_ad_widget', __('Themedy - 125x125 Ads', 'themedy'), $widget_ops, $control_ops );
	}
