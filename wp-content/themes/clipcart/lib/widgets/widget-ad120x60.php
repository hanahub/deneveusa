...
class themedy_ad120x60_widget extends WP_Widget {
	...
	function Themedy_Ad120x60_Widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'themedy_ad120x60_widget', 'description' => __('A widget that allows the display and configuration of of a single 120x60 Banner (Button 2).', 'themedy') );

		/* Widget control settings */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad300_widget' );

		/* Create the widget */
		$this->WP_Widget( 'themedy_ad120x60_widget', __('Themedy - 120x60 Ad', 'themedy'), $widget_ops, $control_ops );
	}
