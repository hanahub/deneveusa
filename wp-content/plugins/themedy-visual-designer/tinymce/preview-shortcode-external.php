...
$themedy_theme_css = get_stylesheet_directory_uri() . '/style.css';
...
?>
<?php do_action( 'themedy_shortcode_generator_preview_footer' ); ?>
<script type="text/javascript">

    jQuery( '#themedy-preview h3:first', window.parent.document).removeClass( 'themedy-loading' );
